  ...
  return [
    {
      ...
      images: [
        ...
        `${siteUrl}/benchmarks/provider-hires/comfyui/hires-balanced-64/alpine-valley.png`,
        `${siteUrl}/benchmarks/provider-hires/comfyui/hires-balanced-128/alpine-valley.png`,
        `${siteUrl}/benchmarks/provider-hires/comfyui/hires-conservative-64/alpine-valley.png`,
        `${siteUrl}/benchmarks/provider-hires/comfyui/ultra-64/alpine-valley-ultra.png`,
      ],
    },
